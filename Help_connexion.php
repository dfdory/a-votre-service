...
<body data-post="free-responsive-html5-businessportfolio-template-amazingbiz">
 ...
 echo "<strong><h4>PARAMETRES DE CONNEXION INCORRECT</strong></h4>";
 }?>
                            <div class="contact_form">  
                            	<div id="note"></div>
                                <div id="fields">
                                    <form id="" action="Help_connexion_valide.php" method="post">
                                        ...
                                        <input type="submit" class="contact_btn" value="Connexion !!!" />
                                        <div class="clear"></div>
                                    </form>
                                </div>
								<a href="help_modif_pass.php">Mot de passe oubli&eacute;</a>
                            </div>
