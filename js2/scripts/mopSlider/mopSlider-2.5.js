...
jQuery.fn.extend({
	mopSlider:function(stt){
		...
		var mopSldSrc=function(mopSldTyp){
			if(mopSldTyp=="paper"){
				btnLeft.src="js/scripts/mopSlider/paper/sliderBtnLtW.png";
				btnLeftF.src="js/scripts/mopSlider/paper/sliderBtnLtW_f.png";
				btnRight.src="js/scripts/mopSlider/paper/sliderBtnRtW.png";
				btnRightF.src="js/scripts/mopSlider/paper/sliderBtnRtW_f.png";
				btnCenter.src="js/scripts/mopSlider/paper/sliderBtnW.png";
				btnChange.src="js/scripts/mopSlider/paper/sliderBkRtRtW.png";
				btnChangeNn.src="js/scripts/mopSlider/paper/sliderBkRtRtNnW.png";
				btnChangeF.src="js/scripts/mopSlider/paper/sliderBkRtRtW_f.png";
				bkImg.src="js/scripts/mopSlider/paper/paperBk.gif";
				sldcLeftImg.src="js/scripts/mopSlider/paper/sliderBkLtLtW.png";
				sldBkLeft.src="js/scripts/mopSlider/paper/sliderBkLtW.png";
				sldBkCenter.src="js/scripts/mopSlider/paper/sliderBkW.png";
				sldBkRight.src="js/scripts/mopSlider/paper/sliderBkRtW.png";
			}
			
			else if(mopSldTyp=="black"){
				btnLeft.src="js/scripts/mopSlider/black/sliderBtnLt.png";
				btnLeftF.src="js/scripts/mopSlider/black/sliderBtnLt_f.png";
				btnRight.src="js/scripts/mopSlider/black/sliderBtnRt.png";
				btnRightF.src="js/scripts/mopSlider/black/sliderBtnRt_f.png";
				btnCenter.src="js/scripts/mopSlider/black/sliderBtn.png";
				btnChange.src="js/scripts/mopSlider/black/sliderBkRtRt.png";
				btnChangeNn.src="js/scripts/mopSlider/black/sliderBkRtRtNn.png";
				btnChangeF.src="js/scripts/mopSlider/black/sliderBkRtRt_f.png";
				bkImg.src="js/scripts/mopSlider/black/monoBk.gif";
				sldcLeftImg.src="js/scripts/mopSlider/black/sliderBkLtLt.png";
				sldBkLeft.src="js/scripts/mopSlider/black/sliderBkLt.png";
				sldBkCenter.src="js/scripts/mopSlider/black/sliderBk.png";
				sldBkRight.src="js/scripts/mopSlider/black/sliderBkRt.png";
			}

			else if(mopSldTyp=="ostemplates"){
				btnLeft.src="js/scripts/mopSlider/ostemplates/sliderBtnLtW.png";
				btnLeftF.src="js/scripts/mopSlider/ostemplates/sliderBtnLtW_f.png";
				btnRight.src="js/scripts/mopSlider/ostemplates/sliderBtnRtW.png";
				btnRightF.src="js/scripts/mopSlider/ostemplates/sliderBtnRtW_f.png";
				btnCenter.src="js/scripts/mopSlider/ostemplates/sliderBtnW.png";
				btnChange.src="js/scripts/mopSlider/ostemplates/sliderBkRtRtW.png";
				btnChangeNn.src="js/scripts/mopSlider/ostemplates/sliderBkRtRtNnW.png";
				btnChangeF.src="js/scripts/mopSlider/ostemplates/sliderBkRtRtW_f.png";
				bkImg.src="js/scripts/mopSlider/ostemplates/ostemplatesBk.gif";
				sldcLeftImg.src="js/scripts/mopSlider/ostemplates/sliderBkLtLtW.png";
				sldBkLeft.src="js/scripts/mopSlider/ostemplates/sliderBkLtW.png";
				sldBkCenter.src="js/scripts/mopSlider/ostemplates/sliderBkW.png";
				sldBkRight.src="js/scripts/mopSlider/ostemplates/sliderBkRtW.png";
			}
		...
		if(stt.itemMgn==null){itemMgn=18};
