...
<body data-post="free-responsive-html5-businessportfolio-template-amazingbiz">
	<div class="container box_shadow">
		...
		<div class="breadcrumb">
				<div>
					<a href="index.php">Home</a><span>/</span>Inscription
				</div>
			</div>
                        	<h2 class="title">Inscrivez vous gratuiment sur Help Services</h2>
							<?php if(isset($_REQUEST['err']) &&$_REQUEST['err']==1){
 									echo "<strong><h4>ERREUR LORS DE L&rsquo;ENREGISTREMENT</strong></h4>";
								 }
								 elseif(isset($_REQUEST['err']) &&$_REQUEST['err']==2){echo "<strong><h4>E-MAIL INDISPONIBLE</strong></h4>";}?>
                            <div class="contact_form">  
                            	<div id="note"></div>
                                <div id="fields">
                                    <form id="" action="Help_inscription_valide.php" method="post">
									<label>qu'aimeriez vous faire?</label>
										<p>
										  <label>
										    <input type="radio" name="choix" value="1" required >
										    Je propose de l'aide</label>
										  <label>
										    <input type="radio" name="choix" value="2" required>
										    Je cherche de l'aide</label>
										  <br>
									  </p>
                                      ...
                                      <input class="span7" type="text" name="nom" value="" placeholder="Nom (required)" required/>
									  <input class="span7" type="text" name="prenom" value="" placeholder="Prenom (required)"  required/>
                                        ...
                                        <input type="submit" class="contact_btn" value="S'inscrire !!!" />
                                        <div class="clear"></div>
                                    </form>
                                </div>
                            </div>
